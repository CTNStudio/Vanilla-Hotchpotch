...
import com.ctn.vanilla_hotchpotch.common.block.saucepan.SaucepanBlock;
...
public class VhBlocks {
	...
	public static final DeferredBlock<SaucepanBlock> SAUCEPAN = registerEntityBlock(
			...
			BlockBehaviour.Properties.of().mapColor(MapColor.STONE).requiresCorrectToolForDrops().strength(2.0F).noOcclusion().forceSolidOn());
